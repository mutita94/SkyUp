...
<?php
	...
	?>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="h3 mb-0 text-gray-800">
                                <button type="button" class="btn btn-success ">เพิ่มสินค้า</span></button>
                                <a href ="insert_color.php"><button type="button" class="btn btn-success ">เพิ่มเฉดสี</span></button></a> 
                        </div>
                    </div>


                    <!-- Page Heading -->
                  <h1 class="h3 mb-2 text-gray-800">เพิ่มสินค้าใหม่</h1>
        ...
        <div class="card-body">
          <div class="table-responsive">
            ...
            <input id="aid" name="aid" type="text" placeholder="" class="form-control input-md" required>		
              ...
              <!-- Text input-->
            <div class="form-group">
            <label class="col-md-4 control-label" for="a_name">ชื่อสินค้า</label>  
            <div class="col-md-4">
             ...
             <div class="form-group">
                ...
                <div class="col-md-4">	
                    <select name ="abrand" class="form-control" aria-label=".form-select-lg example" >
                        ...
                        <option value="Beger ราคาพิเศษ">Begerลดราคา</option>
                        <option value="TOA ราคาพิเศษ">TOA ลดราคา</option>
                        </select>
                  </div>
			        </div>
               <!-- Text input
               <div class="form-group">
                  ...
                  <input id="astock" name="astock" type="text" placeholder="" class="form-control input-md" required>		
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">	
                        ...
                        <option value="สีรองพื้นปูนเก่า">สีรองพื้นปูนเก่า</option>
                        <option value="สีรองพื้นปูนใหม่">สีรองพื้นปูนใหม่</option>
                        <option value="รองพื้นกันสนิม">รองพื้นกันสนิม</option>
                        </select>
                  </div>
			        </div>
                <!-- Text input-->
                ...
                <!-- Text input-->
                <div class="form-group">
                <label class="col-md-4 control-label" for="a_cost">ต้นทุน</label>  
                <div class="col-md-4">
                <input id="acost" name="acost" type="text" placeholder="" class="form-control input-md" required>		
                </div>
                </div>
                <!-- Text input
                <div class="form-group">
                <label class="col-md-4 control-label" for="a_totalsale">ราคาขายรวม</label>  
                <div class="col-md-4">
                <input id="atotalsale" name="atotalsale" type="text" placeholder="" class="form-control input-md" required>		
                </div>
                </div>-->
             <!-- Text input
             <div class="form-group">
	...
	<?php
        ...
        $sql = "INSERT INTO product VALUES(null, '".$_POST['aname']."', '-' , '".$_POST['asize']."',
             '".$_POST['aunit']."', '".$_POST['astock']."','".$_POST['asale']."' , '".$_POST['acost']."', '0' , '0',
             '".$_POST['acategory']."', '".$_POST['aproperty']."' ,'0','0','".$_POST['abrand']."','".$_FILES['aimages']['name']."')";
        ...
        $sql1 = "UPDATE product SET a_totalcost = '".$_POST['astock']."' * '".$_POST['acost']."' , a_totalsale = '".$_POST['astock']."' * '".$_POST['asale']."' ";
