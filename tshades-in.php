          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <?php
                include("condb.php");
                    ...
                    $sql = "SELECT * FROM  product WHERE  (a_brand LIKE '%Super%')"; 
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                      ...
                      echo "<table width='91' border='0' cellspacing='0' cellpadding='0'>";
                        echo "<tr>";
                        echo "<td><a href='cart.php?p_id=$row[a_id]&act=add'><img src='images/" . $row["a_images"] . "' width='190' height='100' border='1'></a></td>";
                            echo "</tr>";
                            echo "<tr>";
